...

{
    ...
    int quantum_time = targ->quantum_time;
...

{
    ...
    targ2.quantum_time = 16;

    // printf("q:%d - c:%d - qt:%d\n", targ.q->rear, targ.cpu->cpu_ram,targ.quantum_time);
    ...
    pthread_create(&tid1, NULL, (void *)roundRobin, (void *)&targ);

    printf("\n----CPU-2 Round Robin Algorithm (queue 3, Quantum time: 16)----\n");

    // roundRobin(&cpu2_queue3, &cpu2, 16);

    pthread_create(&tid2, NULL, (void *)roundRobin, (void *)&targ2);
